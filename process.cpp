...
{
  flaw(sig != SIGCHLD, posix::warning, posix::seterror(std::errc::invalid_argument),,
...
{
  flaw(m_state != State::Initializing, posix::severe, posix::seterror(std::errc::device_or_resource_busy), false,
